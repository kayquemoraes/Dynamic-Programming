...
'''
arvore100={'raiz':100,'direita':{'raiz':110,'direita':{},'esquerda':{}},'esquerda':{'raiz':30,'direita':{'raiz':40,'direita':{},'esquerda':{}},'esquerda':{}}}
...
'''
def tudo_a_esquerda_recursivo(arvore):
    if arvore_esquerda(arvore) != {}:
        arvore_nova_esquerda = arvore_esquerda(arvore)
        return tudo_a_esquerda(arvore_nova_esquerda)
    else:
        return raiz(arvore)

def tudo_a_esquerda(arvore):
    while arvore_esquerda(arvore) != {}:
        arvore = arvore_esquerda(arvore)
    return raiz(arvore)
